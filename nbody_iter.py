"""
    ...
    1. using combinations in forming key pairs
    2. using iter(keys) when enumerating BODIES.keys
    3. tried to replace the "range" function with "itertools.islice(count(), iterations)" but got no improvement
"""
